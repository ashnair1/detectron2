...
class PAFPN(Backbone):
    """
    This module implements the Path Aggregated Feature Pyramid Network.
    The backbone is virtually identical to the FPN except for an additional
    bottom up branch. Refer paper here: https://arxiv.org/pdf/1803.01534.pdf
    """
    ...
    def forward(self, x):
        ...
        for features, lateral_conv, midout_conv in zip(
            ...
            if self._fuse_type == "avg":
                prev_features /= 2
            prev_cache.append(midout_conv(prev_features))
        ...
        results.append(self.output_convs[0](prev_tu_features))  # Step might be unnecessary
        ...
        for features, lateral_conv, output_conv, c1, c2 in zip(
            ...
            bottom_up_features2 = nn.functional.relu(c1(prev_tu_features))
            lateral_features = lateral_conv(features)
            prev_tu_features = lateral_features + bottom_up_features2
